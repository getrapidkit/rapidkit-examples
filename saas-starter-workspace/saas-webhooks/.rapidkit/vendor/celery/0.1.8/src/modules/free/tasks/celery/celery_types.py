"""Typed helpers for Celery module metadata serialization."""
...
class CeleryBeatEntrySnapshot:
    ...
    @classmethod
    def from_mapping(cls, name: str, payload: Mapping[str, Any] | None) -> "CeleryBeatEntrySnapshot":
        data = payload or {}
        return cls(
            name=name,
...
class CeleryHealthSnapshot:
    ...
    namespace: str | None
    beat_schedule: tuple[CeleryBeatEntrySnapshot, ...]
    ...
    def from_mapping(
        ...
        *,
        ...
        if isinstance(beat_payload, Mapping):
            beat_schedule = tuple(
                CeleryBeatEntrySnapshot.from_mapping(name, entry)
...
def as_dict(snapshot: CeleryHealthSnapshot) -> MutableMapping[str, Any]:
