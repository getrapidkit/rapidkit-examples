"""Typed helpers for Users Profiles metadata serialization."""
...
class UsersProfilesHealthSnapshot:
...
def as_dict(snapshot: UsersProfilesHealthSnapshot) -> MutableMapping[str, Any]:
