"""Health helpers for Observability Core."""
...
try:
    from .observability_core import MODULE_NAME
except Exception:  # pragma: no cover - fallback when relative import unavailable
    MODULE_NAME = "observability_core"

try:
    from .observability_core_types import ObservabilitySummary
except Exception:  # pragma: no cover - fallback to project types or shim
    try:
        from src.types.observability_core import ObservabilitySummary  # type: ignore
    except Exception:
