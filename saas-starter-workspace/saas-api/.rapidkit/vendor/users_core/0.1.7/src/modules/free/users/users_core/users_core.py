"""Runtime helpers for Users Core metadata and configuration."""
...
DEFAULT_ENV_PREFIX = "RAPIDKIT_USERS_CORE_"
...
class UsersCoreConfig:
    """Normalized configuration for Users Core."""
    ...
    @classmethod
    def from_mapping(cls, payload: Mapping[str, Any]) -> "UsersCoreConfig":
        defaults = cls()
        return cls(
...
def load_config_from_env(
    ...
    return UsersCoreConfig.from_mapping(payload)


def describe_users_core(
    config: UsersCoreConfig | None = None,
) -> MutableMapping[str, Any]:
    """Return metadata describing the Users Core configuration."""
...
def get_users_core_metadata() -> MutableMapping[str, Any]:
    """Collect metadata using environment-backed configuration."""

    return describe_users_core()
