"""Runtime helpers for Users Profiles metadata and configuration."""
...
DEFAULT_ENV_PREFIX = "RAPIDKIT_USERS_PROFILES_"
...
class UsersProfilesConfig:
    """Normalized configuration for Users Profiles."""
    ...
    @classmethod
    def from_mapping(cls, payload: Mapping[str, Any]) -> "UsersProfilesConfig":
        defaults = cls()
...
def load_config_from_env(
    ...
    return UsersProfilesConfig.from_mapping(payload)


def describe_users_profiles(
    config: UsersProfilesConfig | None = None,
) -> MutableMapping[str, Any]:
    """Return metadata describing the Users Profiles configuration."""
...
def get_users_profiles_metadata() -> MutableMapping[str, Any]:
    """Collect metadata using environment-backed configuration."""

    return describe_users_profiles()
