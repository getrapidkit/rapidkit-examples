"""FastAPI route definitions for Inventory."""
...
def build_router(*, service: InventoryService | None = None) -> APIRouter:
    router = APIRouter(prefix="/inventory", tags=["Inventory"])
    facade = service or InventoryService()

    @router.get("/health", summary="Inventory health check")
