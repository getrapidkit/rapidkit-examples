...
Generated by RapidKit - DatabasePostgres
"""
...
def build_default_config() -> DatabasePostgresConfig:
    """
    Return default configuration payload for PostgreSQL.

    Returns:
        DatabasePostgresConfig: Default database configuration
    """
    return DatabasePostgresConfig()


def get_engine_config(config: DatabasePostgresConfig) -> Dict[str, Any]:
    """
...
def validate_config(config: DatabasePostgresConfig) -> bool:
    """
