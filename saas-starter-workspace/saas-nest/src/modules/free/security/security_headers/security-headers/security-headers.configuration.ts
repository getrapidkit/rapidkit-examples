...
import type { SecurityHeadersOptions } from './security-headers.service';
...
const PERMISSIONS_DEFAULTS = {} as UnknownRecord;
const ADDITIONAL_HEADERS_DEFAULTS = {} as UnknownRecord;
...
export type SecurityHeadersConfiguration = SecurityHeadersOptions;
