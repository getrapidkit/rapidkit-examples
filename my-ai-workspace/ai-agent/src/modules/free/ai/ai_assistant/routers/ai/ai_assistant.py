"""FastAPI router glue for Ai Assistant."""
...
# Store global instance for dependencies
_assistant_instance: AiAssistant | None = None


def _get_assistant() -> AiAssistant:
    """Dependency to retrieve the assistant instance."""
    global _assistant_instance
...
def build_health_router() -> APIRouter:
    ...
    router = APIRouter(prefix="/ai/assistant", tags=["Ai Assistant Health"])
    ...
    async def healthcheck(
        ...
        runtime_snapshot = assistant.health_report()
        return {
