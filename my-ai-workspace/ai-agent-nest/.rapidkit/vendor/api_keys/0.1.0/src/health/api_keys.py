...
def _rotation_deadline(record: ApiKeysRecord, config: ApiKeysConfig) -> datetime | None:
...
def _compute_rotation_due(
    records: Sequence[ApiKeysRecord],
    *,
...
def build_health_payload(
    *,
    ...
    recent_records: Sequence[ApiKeysRecord],
