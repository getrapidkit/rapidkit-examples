"""Structured logging runtime for Logging."""
...
_DEFAULTS = json.loads(r'''{"async_queue": true, "enable_redaction": true, "file_path": "logs/app.log", "format": "json", "level": "INFO", "metrics_bridge_enabled": false, "otel_bridge_enabled": false, "sampling_rate": 1.0, "sinks": ["stderr"]}''')
_FALLBACK_DEFAULTS = {
    "level": "INFO",
    "format": "json",
    "sinks": ["stderr"],
