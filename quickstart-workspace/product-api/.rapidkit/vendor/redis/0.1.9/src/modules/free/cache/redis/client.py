"""Redis runtime implementation for Redis Cache."""
...
_DEFAULTS = json.loads(r'''{"cache_ttl": 3600, "connect_backoff_base": 0.5, "connect_retries": 3, "db": 0, "host": "localhost", "password": "", "port": 6379, "preconnect": false, "url": "redis://localhost:6379/0", "use_tls": false}''')
_FALLBACK_DEFAULTS = {
